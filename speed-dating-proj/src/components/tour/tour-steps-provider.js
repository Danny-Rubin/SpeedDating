...
export const videochat_steps = [
    ...
    },
    {
        ...
        content: 'Click here to ask to extend the date by 2 minutes, the date will be extended at the last seconds of the date, only in case both participants want too. You can use this once per date.',
        disableBeacon: true
        ,
    },
    {
