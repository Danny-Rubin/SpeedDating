...
export default function MatchCreateForm(props) {
  ...
  const resetStateValues = () => {
    setSession_id(initialValues.session_id);
    setGeneration_timestamp(initialValues.generation_timestamp);
    setIs_active(initialValues.is_active);
    setUser1(initialValues.user1);
    setUser1WantsToExtendMeeting(initialValues.user1WantsToExtendMeeting);
    setUser2(initialValues.user2);
    setUser2WantsToExtendMeeting(initialValues.user2WantsToExtendMeeting);
    setErrors({});
  };
  const validations = {
