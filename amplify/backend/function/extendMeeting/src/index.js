 ...
 */
 exports.handler = async (event) => {
  ...
  if ( meeting["user1"] === userId ) {
      setMeeting(meeting["session_id"],meeting["user1"],meeting["user2"],meeting["timestamp"],true,meeting["user2WantsToExtendMeeting"]);
      return {
          statusCode: 200,
          // Uncomment below to enable CORS requests
          headers: {
      ...
      setMeeting(meeting["session_id"],meeting["user1"],meeting["user2"],meeting["timestamp"],meeting["user1WantsToExtendMeeting"],true);
      return {
          statusCode: 200,
          // Uncomment below to enable CORS requests
          headers: {
